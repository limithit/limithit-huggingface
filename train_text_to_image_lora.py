...
def main():
    ...
    for name in unet.attn_processors.keys():
        ...
        lora_attn_procs[name] = LoRAAttnProcessor(hidden_size=hidden_size, cross_attention_dim=cross_attention_dim,rank=128)
    ...
    train_transforms = transforms.Compose(
        [
            ...
            transforms.CenterCrop((args.height,args.width)) if args.center_crop else transforms.RandomCrop((args.height,args.width)),
